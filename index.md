...
![](images/aws-quickstarts.png)

AWS and HashiCorp are currently working together to create Terraform modules on AWS. 

These are based on popular QuickStart patterns and allow customer to use thier Terraform knowledge to quickly deploy AWS services.
